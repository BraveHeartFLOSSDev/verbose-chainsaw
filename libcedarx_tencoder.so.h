...
undefined4 ReleaseTextEncBuf(int *param_1,int param_2,int param_3,undefined4 param_4,int param_5,int param_6,int param_7);
undefined4 ReturnTextEncBuf(int *param_1,undefined param_2,undefined param_3,undefined param_4,int param_5,undefined param_6,int param_7);
undefined4 RequestTextEncBuf(int *param_1,int *param_2,undefined4 *param_3,undefined4 *param_4,undefined4 *param_5);
